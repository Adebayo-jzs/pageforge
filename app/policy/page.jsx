        ...
        <div className="space-y-32">
          <section className="reveal visible">
            ...
            <p className="text-lg text-landing-ink-muted leading-relaxed mb-6 font-[350]">
              Welcome to Celerify. We are committed to protecting your privacy and ensuring a transparent relationship with our users. This document outlines how we collect, use, and safeguard your data, as well as the terms governing your use of our AI-powered landing page generation services.
            </p>
          </section>
            ...
            <div className="space-y-20">
              ...
              <div className="bg-white border border-landing-border p-8 rounded-2xl shadow-landing-sm">
                ...
                <p className="text-sm text-landing-ink-muted leading-relaxed mb-6 font-[350]">
                  Celerify grants you a non-exclusive, perpetual license to use, host, and modify the code locally generated by our service. The Celerify logo, brand, and platform architecture remains the property of Celerify.
                </p>
